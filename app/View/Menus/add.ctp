...
<?php echo $this->Html->script('menu/menu')?>
...
<div class="bg C1">
		<h3 class="text_header bg Hmargin20 padding5 txtC">Ավելացնել մենյու</h3>
</div>
...
<?php echo $this->Form->create('Menu');?>
	...
	<?php
		...
		echo $this->Form->input('name_ru', array('label' => __("Անունը ռուսերեն"),'type'=>"text"));
	...
	<?php
		...
		echo $this->Form->input('sub_show',array('type'=>'checkbox','default'=>'1','label'=>'Սուբմենյուն երևա'));
		echo $this->Form->input('main_show',array('type'=>'checkbox','default'=>'1','label'=>'Սուբմենյուն երևա մենուների ցուցակում '));  
	?>
	<div class="clear"></div>
