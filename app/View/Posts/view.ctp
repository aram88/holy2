	...
	<?php if (isset($post['Post']) && !empty($post['Post'])):;?>
		<div class="post lh24 Hmargin25 Vmargin30 txtJ">
			<?php if(!empty($post['Post']['img'])):?>
				...
				<?php 
					echo $this->Html->meta(array('property' => 'fb:app_id', 'content'=>'966242223397117'), NULL, array('inline' => false));
						list($width, $height) = getimagesize(WWW_ROOT.'img'.DS.'post'.DS.$post['Post']['img']);
						//echo $this->Html->meta(array('property' => 'og:image:width', 'content'=>$width), NULL, array('inline' => false));
						//echo $this->Html->meta(array('property' => 'og:image:height', 'content'=>$height), NULL, array('inline' => false));
						echo $this->Html->meta(array('property' => 'og:image', 'content' => 'http://www.holytrinity.am/img/post/'.$post['Post']['img']), NULL, array('inline' => false));
						echo $this->Html->meta(array('property' => 'og:title', 'content'=>$post['Post']['name']), NULL, array('inline' => false));
						echo $this->Html->meta(array('property' => 'og:url', 'content'=>'http://www.holytrinity.am/img/post/'.$post['Post']['id']), NULL, array('inline' => false));
						echo $this->Html->meta(array('property' => 'og:description', 'content'=>strip_tags($post['Post']['text'])), NULL, array('inline' => false));
